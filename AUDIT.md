...
| #   | Removed                                                        | Why                                                                                                                                                                                                                                             |
| --- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| S1  | `github-4-mallonepay-pay-per-token-llm-gateway.py` (repo root) | An unrelated **FastAPI** `/health` + `/ready` snippet — no relation to this NestJS gateway; an agent-sweep artifact (referenced only by `NEX_AGENT_DELIVERABLE.md`)                                                                             |
